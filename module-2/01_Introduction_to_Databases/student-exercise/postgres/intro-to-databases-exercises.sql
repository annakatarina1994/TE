...
SELECT name, region FROM country WHERE region NOT LIKE 'Caribbean' AND continent = 'North America' OR continent = 'South America';
...
SELECT name, lifeexpectancy FROM country WHERE lifeexpectancy IS NOT NULL AND continent = 'Oceania';
...
SELECT name, continent, gnp, lifeexpectancy FROM country WHERE  gnp >= 1 AND gnp <= 100 AND lifeexpectancy >= 70;
...
SELECT name, (2020 - indepyear) AS yearsSinceIndep FROM country WHERE indepyear IS NOT NULL;
