...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		Set<String> keys = nameToZip.keySet(); // returns a collection of all the keys
		for(String name: keys) {
			System.out.println(name + " lives in " + nameToZip.get(name));
		}
		
		System.out.println("************** Printing all elements using an entry set *****************");
		for (Map.Entry<String, String> nameZip : nameToZip.entrySet()) {  //Returns collections of k, v pairs
			...
			System.out.println("Enter a zip to search for: ");
