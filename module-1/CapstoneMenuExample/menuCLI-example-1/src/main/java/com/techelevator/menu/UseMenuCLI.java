...
public class UseMenuCLI { // Class representing the MenuCLI process to be used
	...
	public static void main(String[] args) {
		 ...
		 * a good idea as they make the code easier to follow and use
		 *******************************************************************************/
		 ...
		 * be displayed to the user using constants
		 **********************************************************************/

		final String[] MAIN_MENU_OPTIONS = { MAIN_MENU_OPTION_1, MAIN_MENU_OPTION_2, MAIN_MENU_OPTION_3,
		 ...
		 * 
		 * 1. Display the elements of the menu option String array passed to it 2. Ask
		...
		/********************************************************************************
		 * Define array of String constants representing the menu option text/choices to
		 * be displayed to the user using literals.
		 * 
