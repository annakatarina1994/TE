...
function generateProblemSet() {
    for (let i = 0; i < NUMBER_OF_PROBLEMS; i++) {
        ...
        let left = getRandomNumber(10, 85);  // we want to multiplication probs for single digit numbers
        let right = getRandomNumber(10, 85);
        let correctAnswer = left * right;
        let answers = shuffleArray([correctAnswer, getRandomNumber(82, correctAnswer), 
            getRandomNumber(82, correctAnswer), getRandomNumber(82, correctAnswer)]);
...
function displayAnswers() {
    ...
    for (let i = 0; i < answerLoop.length; i++) {
        ...
        // moved click into DOMContentLoaded - SRP!!!
    }
}
...
// make sure answer is not duplicated
