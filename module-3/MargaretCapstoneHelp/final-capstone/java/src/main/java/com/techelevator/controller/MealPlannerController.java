...
//Recipes
	...
	public void addRecipe (@RequestBody Recipe recipe) {
		System.out.println("add recipe: " + recipe.getUserId());
...
//Ingredients
	...
	@ResponseStatus(HttpStatus.CREATED)
	public void addNewIngredientToExistingRecipe(@RequestBody IngredientWithUser ingredientObj, 
			@PathVariable int recipeId) {
		System.out.println("in controller - " + ingredientObj.getUserId());
		ingredientDAO.addNewIngredientToExistingRecipe(ingredientObj, recipeId);
	}
...
//Meals
	...
	@GetMapping("/getSchedule")
		public List<Schedule> listSchedule(int mealPlanId){
	...
	@ResponseStatus(HttpStatus.CREATED)
	public void saveMealSlots(List<Schedule> schedules, int[] dates) {
		scheduleDAO.assignMealTimesInSchedule(schedules, dates);
	}
