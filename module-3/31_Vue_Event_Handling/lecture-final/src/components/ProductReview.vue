  ...
  computed: {
    filteredReviews() {
      return this.reviews.filter((review) => {
        // this.filter === 0 => this is true if they want all reviews back
        // true says return all review elements in the reviews array
        // after the : means this.filter !== 0 and therefore we need to filter
        // this.filter === review.rating (meaning we need to return this review we are looking at)
