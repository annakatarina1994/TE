...
function scopeTest() {
  ...
  {  // can put a block of code anywhere in code -- no reason for this other than to demonstrate this point
...
function biggestNumber(){
  let largest = arguments[0]; // priming read -- starting with an actual value 
...
function sumAllNumbers(numbersToSum) {
  return numbersToSum.reduce(
    ...
    // sum is initialized at ****  at the far left value in your array!!! ****
    (sum, number) => {
...
function allDivisibleByThree(numbersToFilter) {
  ...
  return numbersToFilter.filter(
    (number) => {
      return number % 3 === 0;  // this says if (number % 3 === 0) return number;
    }
  );

}
 /**
  * Take an array and returns a new array of all values cubed
  * 
